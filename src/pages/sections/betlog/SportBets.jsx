...
export default function SportBets() {
    const sportbet = [
        { 
          game: { name: 'Aston villa vs Fulham Fc', icon: '🚀' }, 
          user: 'CryptoKing', 
          time: '11:30am', 
          betAmount: 12.3456, 
          multiplier: '2.34', 
          ...
          <table className="min-w-full bg-[rgb(26,44,56)] rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-[rgb(15,33,46)] text-gray-300 text-xs">
                ...
                <th className="py-3 px-4 text-left">Odd</th>
                <th className="py-3 px-4 text-left">Betamount</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[rgb(15,33,46)]">
              {sportbet.map((bet, index) => (
                <tr 
                  key={index} 
