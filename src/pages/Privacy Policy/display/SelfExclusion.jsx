  ...
  return (
    <div style={{ padding: '30px', fontFamily: 'Arial, sans-serif', lineHeight: '1.6', overflowY: "scroll", maxHeight: "90vh",  }}>
      ...
      <ul>
        ...
        <li>Training our staff about Responsible Gambling at least once each year;</li>
        <li>Referring our customers affected by problem gambling to gambling-related support services.</li>
      </ul>
      ...
      <ul>
        ...
        <li>You won’t be eligible for benefits or bonuses</li>
        <li>Once set, it cannot be revoked until expiry</li>
        <li>An indefinite exclusion lasts at least 6 months</li>
        <li>We are not responsible for any undisclosed or new accounts you open</li>
      </ul>
      <p>If you act against your exclusion agreement, we reserve the right to terminate wagers and accounts. Your account will be subject to internal review for indefinite exclusions.</p>
    </div>
  );
};
